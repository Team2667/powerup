...
public class RobotMap {
    ...
    public static WPI_TalonSRX cubeGrabGrabWindow;
    public static WPI_TalonSRX cubeGrabLiftWindow;
    public static DigitalInput cubeGrabUpperLimitSwitch;
    public static DigitalInput cubeGrabLowerLimitSwitch;
    public static WPI_TalonSRX sideLiftSideLiftLeft;
    public static WPI_TalonSRX sideLiftSideLiftRight;
    ...
    public static void init() {
        ...
        cubeGrabGrabWindow = new WPI_TalonSRX(5);
        
        
        cubeGrabLiftWindow = new WPI_TalonSRX(6);
        ...
        sideLiftSideLiftLeft = new WPI_TalonSRX(7);
        
        
        sideLiftSideLiftRight = new WPI_TalonSRX(8);
